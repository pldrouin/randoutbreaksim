...
void printusage(const char* name)
{
  ...
  printf("\t--p VALUE\t\tbranchsim's p parameter (default value of 0)\n");
  printf("\t--lambda VALUE\t\tbranchsim's lambda parameter (required)\n");
  printf("\t--kappa VALUE\t\tbranchsim's kappa parameter (required)\n");
